...
​
In a further extension of this work modelling the developmental and evolutionary (evo-devo) dynamics of hominin brain size, I have found that, counterintuitively, the sharp expansion in brain size in the human lineage may have been a by-product of selection for mature ovarian follicles, where the role of ecology and culture is not to increase selection for brain size as often assumed, but to generate a genetic correlation between ovarian follicles and brain size, a correlation that causes human brain expansion ([González-Forero, 2024b](https://www.nature.com/articles/s41562-024-01887-8)).
